...
const SURVEY_VERSION = "v5-2026-05";
...
export default function SurveyPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const cohortSeed = window.localStorage.getItem(COHORT_SEED_KEY);
      if (cohortSeed === "yc" || cohortSeed === "general") {
        setResponses((prev) =>
          prev.cohort === undefined ? { ...prev, cohort: cohortSeed } : prev
        );
      }
      window.localStorage.removeItem(COHORT_SEED_KEY);
    } catch {
